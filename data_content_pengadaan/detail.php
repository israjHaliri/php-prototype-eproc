...
$show = mysqli_query($conn,"SELECT * FROM pengadaan WHERE id_pengadaan='$id'");
     ...
     <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="block-text">
          <a><?php echo $data['title_pengadaan']; ?></a>
          <div class="mark">
            <img class="img-thumbnail" src="../assets/image/<?php echo $data ['image_pengadaan']; ?>"/>
          </div>
          <p>
            <?php echo $data['description_pengadaan']; ?>
          </p>
          <div align="right">
            <small><?php echo $data['date_publish_pengadaan']; ?></small>
            <small><?php echo $data['time_publish_pengadaan']; ?></small>
          </div>
