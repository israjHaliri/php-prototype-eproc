     ...
     <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="block-text">
          <a><?php echo $data['title_lelang']; ?></a>
          <div class="mark">
            <img class="img-thumbnail" src="../assets/image/<?php echo $data ['image_lelang']; ?>"/>
          </div>
          <p>
            <?php echo $data['description_lelang']; ?>
          </p>
          <div align="right">
            <small><?php echo $data['date_publish_lelang']; ?></small>
            <small><?php echo $data['time_publish_lelang']; ?></small>
          </div>
