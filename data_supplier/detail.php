     ...
     <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="col-md-12">
          ...
          <div>
            <p><td><label>Alamat</label></td><td>&nbsp;:&nbsp;</td><td><?php echo $data['alamat']; ?></td></p>
          </div>
          <div>
            <p><td><label>Nama Perusahaan Penyedia</label></td><td>&nbsp;:&nbsp;</td><td><?php echo $data['nama_perusahaan_penyedia']; ?></td></p>
          </div>
          <div>
            <p><td><label>No PKP</label></td><td>&nbsp;:&nbsp;</td><td><?php echo $data['no_pkp']; ?></td></p>
          </div>
          <div>
            <p><td><label>Bentuk Usaha</label></td><td>&nbsp;:&nbsp;</td><td><?php echo $data['bentuk_usaha']; ?></td></p>
          </div>
          <div>
            <p> <td><label>NPWP</label></td><td>&nbsp;:&nbsp;</td><td><?php echo $data['npwp']; ?></td></p>
          </div>
          <div>
            <p>  <td><label>Status</label></td><td>&nbsp;:&nbsp;</td><td><?php echo $data['status']; ?></td></p>
          </div>
        </div>
      </div>
    </div>
