...
if(isset($_REQUEST['id']))
{
	...
	$cek = mysqli_query($conn,"SELECT id_supplier FROM supplier WHERE id_supplier='$id'") or die(mysqli_error());
	...
	{
		$del = mysqli_query($conn,"DELETE FROM supplier WHERE id_supplier='$id'");
