...
$show = mysqli_query($conn,"SELECT * FROM eproc WHERE id_eproc='$id'");
...
if(isset($_REQUEST['save']))
{
  ...
  $update = mysqli_query($conn,"UPDATE eproc SET title='$title',description='$description' WHERE id_eproc='$id'") or die(mysqli_error());
