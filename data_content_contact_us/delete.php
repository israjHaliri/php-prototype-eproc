...
if(isset($_REQUEST['id']))
{
	...
	$cek = mysqli_query($conn,"SELECT id_contact FROM contact_us WHERE id_contact='$id'") or die(mysqli_error());
	...
	{	
		$del = mysqli_query($conn,"DELETE FROM contact_us WHERE id_contact='$id'");
