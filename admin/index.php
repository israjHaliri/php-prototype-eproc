  ...
  <section id="container" >
    <header class="header black-bg">
      <div class="sidebar-toggle-box">
        <div class="glyphicon glyphicon-align-justify fa fa-bars tooltips" data-placement="right" data-original-title="Toggle Navigation"></div>
      </div>
...
<section id="main-content">
  <section class="wrapper">
    <div class="col-md-12">
      <div class="col-md-2"><label>Slider</label></div>
      <div class="col-md-6"><input title="" data-original-title="" class="form-control" placeholder="ex.selamat datang" type="text"></div>
